...
def reqOrigem_Para
  ...
  request["plugin-version"] = 'v2.0.0'
  request["content-type"] = 'application/json'
  request.body = "{\"origin_zip_code\":\"66000000\",\"destination_zip_code\":\"66010000\",\"quoting_mode\":\"DYNAMIC_BOX_ALL_ITEMS\",\"products\":[{\"weight\":5,\"cost_of_goods\":10.7,\"width\":15,\"height\":17.5,\"length\":15,\"quantity\":1,\"sku_id\":\"SKU123\",\"product_category\":\"Bebidas\"},{\"weight\":7,\"cost_of_goods\":20.99,\"width\":20.5,\"height\":30.7,\"length\":20,\"quantity\":1,\"sku_id\":\"SKU456\",\"product_category\":\"Bebidas\"}],\"additional_information\":{\"lead_time_business_days\":1,\"sales_channel\":\"CN1\",\"client_type\":\"gold\"},\"identification\":{\"session\":\"04e5bdf7ed15e571c0265c18333b6fdf1434658753\",\"ip\":\"000.000.000.000\",\"page_name\":\"carrinho\",\"url\":\"http://www.intelipost.com.br/checkout/cart/\"}}"
  @response = http.request(request)
end
...
def apiChave_invalida 
   ...
   request = Net::HTTP::Post.new(url)
   request["api-key"] = '4aa90b1087807b5fb8e52b01584f84e415d0f075a2d1e379'
   request["platform"] = 'intelipost-docs'
   request["platform-version"] = 'v1.0.0'
   request["plugin"] = 'intelipost-plugin'
   request["plugin-version"] = 'v2.0.0'
...
def reqValidar_eweight_invalido
   url = URI("https://api.intelipost.com.br/api/v1/quote_by_product")
   ...
   request["plugin-version"] = 'v2.0.0'
   request["content-type"] = 'application/json'
   request.body = "{\"origin_zip_code\":\"8390130\",\"destination_zip_code\":\"04304011\",\"quoting_mode\":\"DYNAMIC_BOX_ALL_ITEMS\",\"products\":[{\"weight\":5,\"cost_of_goods\":10.7,\"width\":15,\"height\":17.5,\"length\":15,\"quantity\":1,\"sku_id\":\"SKU123\",\"product_category\":\"Bebidas\"},{\"weight\":,\"cost_of_goods\":20.99,\"width\":20.5,\"height\":30.7,\"length\":20,\"quantity\":1,\"sku_id\":\"SKU456\",\"product_category\":\"Bebidas\"}],\"additional_information\":{\"lead_time_business_days\":1,\"sales_channel\":\"meu_canal_de_vendas\",\"client_type\":\"gold\"},\"identification\":{\"session\":\"04e5bdf7ed15e571c0265c18333b6fdf1434658753\",\"ip\":\"000.000.000.000\",\"page_name\":\"carrinho\",\"url\":\"http://www.intelipost.com.br/checkout/cart/\"}}"
   @response = http.request(request)
  end 
  def reqDestino_Para
   url = URI("https://api.intelipost.com.br/api/v1/quote_by_product")
  ...
  request["plugin-version"] = 'v2.0.0'
  request["content-type"] = 'application/json'
  request.body = "{\"origin_zip_code\":\"8390130\",\"destination_zip_code\":\"66000000\",\"quoting_mode\":\"DYNAMIC_BOX_ALL_ITEMS\",\"products\":[{\"weight\":5,\"cost_of_goods\":10.7,\"width\":15,\"height\":17.5,\"length\":15,\"quantity\":1,\"sku_id\":\"SKU123\",\"product_category\":\"Bebidas\"},{\"weight\":7,\"cost_of_goods\":20.99,\"width\":20.5,\"height\":30.7,\"length\":20,\"quantity\":1,\"sku_id\":\"SKU456\",\"product_category\":\"Bebidas\"}],\"additional_information\":{\"lead_time_business_days\":1,\"sales_channel\":\"CN2\",\"client_type\":\"gold\"},\"identification\":{\"session\":\"04e5bdf7ed15e571c0265c18333b6fdf1434658753\",\"ip\":\"000.000.000.000\",\"page_name\":\"carrinho\",\"url\":\"http://www.intelipost.com.br/checkout/cart/\"}}"
  @response = http.request(request)
end
